...
export class FactorioComponent {
    ...
    // Images
    public readonly heroImage = 'assets/img/logo.png';

    public planets = [
        {
            name: { ua: 'Вулканус' },
            image: 'assets/img/vulcanus.png',
